...
import yoonproject.config.auth.dto.OAuthAttributes;
import yoonproject.config.auth.dto.SessionUser;
import yoonproject.domain.user.User;
import yoonproject.domain.user.UserRepository;
