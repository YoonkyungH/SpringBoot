...
class MemberRepositoryTest {    // JPA 테스트
    ...
    public void findUsernameList() {
        ...
        // 원래는 assertThat. 지금은 대충 보기 위해 바로 출력한 것
        for (String s : usernameList) { // iter + tab
...
//        em.clear(); // 영속성 컨텍스트 안 데이터를 완전히 날려버림
    ...
    @Test
    public void specBasic() {   // Specifications(명세)
        // given
        Team teamA = new Team("teamA");
        em.persist(teamA);
    ...
    public void queryByExample() {
        ...
        // when
        // Probe 생성
        Member member = new Member("m1");   // m1이라는 객체를 찾고싶다는 걸 도메인 객체로 바로 넣어버린것
        Team team = new Team("teamA");
        member.setTeam(team);

        ExampleMatcher matcher = ExampleMatcher.matching()
                .withIgnorePaths("age");                // = age라는 속성이 있으면 나는 다 무시할거야
